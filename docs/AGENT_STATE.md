...
- origin/main: **`a213874`**. Сверху вниз: `a213874` (мерж PR #27, трек АЗС —
  `F1.1 · FUEL-NAV-001`), `3498bd1`, `4e39cf1`, `cf4890f`, `5ce7092` (четыре
...
- Staging: `main` = **`a213874`**, совпадает с `origin/main`. Production —
  `361661c`, тег `v1.6`: отстаёт на мерж PR #27 и четыре его коммита, то есть
  строки меню модуля АЗС на проде пока нет. На staging применён
