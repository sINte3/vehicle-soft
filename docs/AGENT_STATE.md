...
- Production: **`0b74e3f`**. Развёрнутый релиз — **`f085c46`** (мерж PR #25,
  ...
  коммиты доков. Тега на этот релиз нет — деплой был непреднамеренным, см.
  ниже. Production, staging и `origin/main` на одном коммите `0b74e3f`.
...
- origin/main: **`0b74e3f`**. Сверху вниз: `0b74e3f` (доки, закрытие
...
- Staging: `main` = **`0b74e3f`**, совпадает с production и с `origin/main`.
  Площадки разошлись только по данным, не по коду. На staging применён
