...
| `sources_descriptor_refused>=1` | прямой запрос получил 3xx/401/403/5xx/сбой/не-дескриптор | проверить сессию DJI и повторить; отсутствием это не считается никогда |
