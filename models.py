...
# действующей версии (`drone_useful_area.ALGORITHM_VERSION`; с 2026-09-05 --
# `useful-area-v2`, `useful-area-v1` считается только для регрессионного
# повтора). Смена версии правил обязана переписать вывод и не имеет права
# тронуть принятые данные.
#
