...
DRONE_COVERAGE_REASON_LABELS = {
    ...
    ua.REASON_UNROUTED_FLIGHT_NOT_ASSIGNABLE: (
        'В этот день у машины несколько работ, и вылет без маршрута нельзя '
        'отнести к одной из них',
        'Бу куни машинада бир нечта иш бор, маршрутсиз парвозни улардан '
        'бирига боғлаб бўлмайди'),
}
