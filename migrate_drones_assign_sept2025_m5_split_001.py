...
одна.
  ...
  4. СПРАВОЧНИК КОНТУРОВ DJI (снимок DRONE-LANDS-001): контуры roziya5
     (07.09.2025, 4.62 га) и roziya bekova 1..5, 1.1 (21.09.2025, 20.44 га).

     ПОПРАВКА 2026-08-19. Раньше здесь стояло «одиннадцать контуров roziya
     дают 34.39 га против 34.5 га книги -- 99.7 %». Неверно: четыре из
     одиннадцати созданы в ИЮЛЕ 2026 года, через десять месяцев, и в счёт
     сентября идти не могут. Сентябрьские дают 25.06 га -- и это совпадает
     не с наличной строкой на 34.5 га, а со СПРАВКОЙ «Розия Бекова 25.0».
     Наличную строку подтверждает не справочник, а сама телеметрия:
     34.36 га вылетов 05-06.09 против 34.5 га книги. Вывод миграции от
     поправки не меняется -- он держится на трёх остальных источниках.
