...
EXPECTED_BY_MONTH = (
    ...
    ('2026-04', 331, 6388.83),
    ('2026-05', 106, 2179.72),
    # [REASON]: 2026-06 — не прогноз владельца 2026-08-04 (июньских книг
    # тогда не существовало), а факт предпросмотра загрузок 2026-08-11:
    # «ИЮНЬ Агрокластер» 24 строки / 820.30 га + «Сервис … Июнь» 70 / 1 182.34.
    ('2026-06', 94, 2002.64),
    ('2026-07', 6, 62.73),
)
